...
// HTTP server with StreamableHTTP transport (for Railway / remote Claude Desktop)
// Also usable as stdio for local Claude Desktop via: node index.js --stdio
...
httpServer.listen(PORT, '0.0.0.0', () => console.log(`[shopify-mcp] port ${PORT} | shop: ${SHOP}`));
